...
class EnergyClimateModel extends Model
{
    ...
    {
        return $this->select('energy_climate.*, 
                             creator.name as created_by_name,
                             verifier.name as verified_by_name')
                    ->join('users as creator', 'creator.id = energy_climate.created_by', 'left')
                    ->join('users as verifier', 'verifier.id = energy_climate.verified_by', 'left')
                    ->orderBy('energy_climate.tahun', 'DESC')
                    ->findAll();
    }
