...
class WaterManagementModel extends Model
{
    ...
    {
        return $this->select('water_management.*, 
                             creator.name as created_by_name,
                             verifier.name as verified_by_name')
                    ->join('users as creator', 'creator.id = water_management.created_by', 'left')
                    ->join('users as verifier', 'verifier.id = water_management.verified_by', 'left')
                    ->orderBy('water_management.tahun', 'DESC')
                    ->findAll();
    }
