...
<div class="card">
    <h3 style="margin-bottom: 20px; color: #333;">Tambah User Baru</h3>
    ...
    <form method="post" action="<?= base_url('users/store') ?>">
        ...
        <div class="form-group" id="unit-field" style="display: none;">
            ...
            <select class="form-control" id="unit" name="unit">
                ...
                <option value="sarpras" <?= old('unit') == 'sarpras' ? 'selected' : '' ?>>Sarpras</option>
                <option value="umum" <?= old('unit') == 'umum' ? 'selected' : '' ?>>Umum</option>
                <option value="lppm" <?= old('unit') == 'lppm' ? 'selected' : '' ?>>LPPM</option>
            </select>
