...
<head>
    ...
    <title><?= $title ?? 'Dashboard User - UIGM' ?></title>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="<?= base_url('user-dashboard/settings') ?>" class="dropdown-item">
                            <i class="fas fa-cog mr-2"></i> Pengaturan
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="<?= base_url('user-dashboard/logout') ?>" class="dropdown-item">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <!-- Dashboard -->
                        <li class="nav-item">
                            <a href="<?= base_url('user-dashboard') ?>" class="nav-link <?= ($page ?? '') == 'dashboard-user' ? 'active' : '' ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('user-dashboard/waste-management') ?>" class="nav-link <?= ($page ?? '') == 'waste-management-input' ? 'active' : '' ?>">
                        ...
                        <!-- Pengaturan -->
                        <li class="nav-item">
                            <a href="<?= base_url('user-dashboard/settings') ?>" class="nav-link <?= ($page ?? '') == 'settings' ? 'active' : '' ?>">
                        ...
                        <!-- Logout -->
                        <li class="nav-item">
                            <a href="<?= base_url('user-dashboard/logout') ?>" class="nav-link">
