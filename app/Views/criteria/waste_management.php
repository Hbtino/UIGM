                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <div class="progress">
                                                        <div class="progress-bar" style="background: linear-gradient(135deg, #149823ff 0%, #0b5804ff 100%); width: 45%"></div>
                                                    </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <div class="progress">
                                                        <div class="progress-bar" style="background: linear-gradient(135deg, #4CAF50 0%, #2E7D32 100%); width: 65%"></div>
                                                    </div>
                                                    <span class="progress-description">
                                                        Target: 85% pada 2028
                                                    </span>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="info-box">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <div class="progress">
                                                        <div class="progress-bar" style="background: linear-gradient(135deg, #66BB6A 0%, #43A047 100%); width: 70%"></div>
                                                    </div>
                                                    <span class="progress-description">
