...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('waste-management/revisions') ?>" class="btn btn-secondary">
        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    <table class="table table-sm table-bordered">
                        <tr>
                            ...
                            <td>
                                <?php if ($WasteManagement['status_verifikasi'] === 'pending'): ?>
                                    <span class="badge badge-warning">Pending</span>
                                <?php elseif ($WasteManagement['status_verifikasi'] === 'approved'): ?>
            ...
            <?php if ($WasteManagement['bukti_pendukung']): ?>
                <div class="mb-4">
                    ...
                    <a href="<?= base_url('waste-management/download/' . $WasteManagement['id']) ?>" class="btn btn-info btn-sm mt-2">
            ...
            <?php if ($revision['status'] == 'pending'): ?>
                ...
                <form action="<?= base_url('waste-management/process-revision-review/' . $revision['id']) ?>" method="post">
                    <?= csrf_field() ?>
