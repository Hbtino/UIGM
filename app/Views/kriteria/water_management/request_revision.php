...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 text-white" style="background: linear-gradient(135deg, #149823ff 0%, #0b5804ff 100%);">
            <h6 class="m-0 font-weight-bold">Request Revisi - Tahun <?= $WaterManagement['tahun'] ?></h6>
        </div>
        <div class="card-body">
            ...
            <form action="<?= base_url('water-management/submit-revision-request/' . $WaterManagement['id']) ?>" method="post">
                <?= csrf_field() ?>
