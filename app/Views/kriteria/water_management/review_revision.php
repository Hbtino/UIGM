...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('water-management/revisions') ?>" class="btn btn-secondary">
        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    <table class="table table-sm table-bordered">
                        <tr>
                            ...
                            <td>
                                <?php if ($WaterManagement['status_verifikasi'] === 'pending'): ?>
                                    <span class="badge badge-warning">Pending</span>
                                <?php elseif ($WaterManagement['status_verifikasi'] === 'approved'): ?>
                        ...
                        <tr>
                            ...
                            <td><strong class="text-primary"><?= number_format($WaterManagement['capaian_persen'], 2) ?>%</strong></td>
                        </tr>
                        <tr>
            ...
            <?php if ($WaterManagement['bukti_pendukung']): ?>
                <div class="mb-4">
                    ...
                    <a href="<?= base_url('water-management/download/' . $WaterManagement['id']) ?>" class="btn btn-info btn-sm mt-2">
            ...
            <?php if ($revision['status'] == 'pending'): ?>
                ...
                <form action="<?= base_url('water-management/process-revision-review/' . $revision['id']) ?>" method="post">
                    <?= csrf_field() ?>
