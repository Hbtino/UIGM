...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('energy-climate') ?>" class="btn btn-secondary">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('energy-climate/update/' . $energyClimate['id']) ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="tahun" name="tahun" 
                                   value="<?= old('tahun', $energyClimate['tahun']) ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="total_konsumsi_listrik" 
                                   name="total_konsumsi_listrik" value="<?= old('total_konsumsi_listrik', $energyClimate['total_konsumsi_listrik']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="konsumsi_energi_terbarukan" 
                                   name="konsumsi_energi_terbarukan" value="<?= old('konsumsi_energi_terbarukan', $energyClimate['konsumsi_energi_terbarukan']) ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="total_listrik_per_orang" 
                                   name="total_listrik_per_orang" value="<?= old('total_listrik_per_orang', $energyClimate['total_listrik_per_orang']) ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="peralatan_hemat_energi" 
                                   name="peralatan_hemat_energi" value="<?= old('peralatan_hemat_energi', $energyClimate['peralatan_hemat_energi']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="bangunan_cerdas" 
                                   name="bangunan_cerdas" value="<?= old('bangunan_cerdas', $energyClimate['bangunan_cerdas']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="jumlah_energi_terbarukan" 
                                   name="jumlah_energi_terbarukan" value="<?= old('jumlah_energi_terbarukan', $energyClimate['jumlah_energi_terbarukan']) ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="bangunan_ramah_lingkungan" 
                                   name="bangunan_ramah_lingkungan" value="<?= old('bangunan_ramah_lingkungan', $energyClimate['bangunan_ramah_lingkungan']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="jejak_karbon_per_orang" 
                                   name="jejak_karbon_per_orang" value="<?= old('jejak_karbon_per_orang', $energyClimate['jejak_karbon_per_orang']) ?>" required>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="program_pengurangan_emisi" 
                                       ...
                                       <?= old('program_pengurangan_emisi', $energyClimate['program_pengurangan_emisi']) ? 'checked' : '' ?>>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="program_inovatif_energi" 
                                       ...
                                       <?= old('program_inovatif_energi', $energyClimate['program_inovatif_energi']) ? 'checked' : '' ?>>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="program_dampak_iklim" 
                                       ...
                                       <?= old('program_dampak_iklim', $energyClimate['program_dampak_iklim']) ? 'checked' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="keterangan" name="keterangan" rows="3"><?= old('keterangan', $energyClimate['keterangan']) ?></textarea>
                </div>

                <div class="form-group">
                    <label for="bukti_pendukung">Bukti Pendukung</label>
                    <?php if ($energyClimate['bukti_pendukung']): ?>
                        <p class="text-muted">File saat ini: <?= $energyClimate['bukti_pendukung'] ?></p>
                    <?php endif; ?>
