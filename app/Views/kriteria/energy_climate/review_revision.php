...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('energy-climate/revisions') ?>" class="btn btn-secondary">
        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    <table class="table table-sm table-bordered">
                        <tr>
                            ...
                            <td>
                                <?php if ($energyClimate['status_verifikasi'] === 'pending'): ?>
                                    <span class="badge badge-warning">Pending</span>
                                <?php elseif ($energyClimate['status_verifikasi'] === 'approved'): ?>
                        ...
                        <tr>
                            ...
                            <td><strong class="text-primary"><?= number_format($energyClimate['capaian_persen'], 2) ?>%</strong></td>
                        </tr>
                        <tr>
            ...
            <?php if ($energyClimate['bukti_pendukung']): ?>
                <div class="mb-4">
                    ...
                    <a href="<?= base_url('energy-climate/download/' . $energyClimate['id']) ?>" class="btn btn-info btn-sm mt-2">
            ...
            <?php if ($revision['status'] == 'pending'): ?>
                ...
                <form action="<?= base_url('energy-climate/process-revision-review/' . $revision['id']) ?>" method="post">
                    <?= csrf_field() ?>
