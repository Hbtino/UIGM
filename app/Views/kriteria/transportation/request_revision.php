    ...
    <div class="col-md-10 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <table class="table table-sm table-bordered">
                            ...
                            <tr>
                                <th>Persentase</th>
                                <td><strong class="text-success"><?= $data_item['capaian_persen'] ?>%</strong></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="/transportation/submit-revision-request/<?= $data_item['id'] ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Contoh: Data perjalanan ramah lingkungan perlu diperbarui karena ada survei terbaru yang menunjukkan peningkatan penggunaan sepeda kampus.</small>
                    </div>
