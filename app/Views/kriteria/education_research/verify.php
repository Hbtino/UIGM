...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-info text-white">
            <h6 class="m-0 font-weight-bold">Verifikasi Data - Tahun <?= $EducationResearch['tahun'] ?></h6>
        </div>
        <div class="card-body">
                ...
                <div class="col-md-6">
                    <table class="table table-sm table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?= number_format($EducationResearch['total_listrik_per_orang'], 2) ?> kWh</td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-6">
                    <table class="table table-sm table-bordered">
                        <tr>
                            ...
                            <td><?= $EducationResearch['peralatan_hemat_energi'] ?> unit</td>
                        </tr>
                        <tr>
                            <th>Bangunan Cerdas</th>
                            <td><?= $EducationResearch['bangunan_cerdas'] ?> unit</td>
                        </tr>
                        <tr>
                            <th>Sumber Energi Terbarukan</th>
                            <td><?= $EducationResearch['jumlah_energi_terbarukan'] ?> unit</td>
                        </tr>
                        <tr>
                            <th>Bangunan Ramah Lingkungan</th>
                            <td><?= $EducationResearch['bangunan_ramah_lingkungan'] ?> unit</td>
                        </tr>
                        <tr>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <ul>
                        <li>Program Pengurangan Emisi: <strong><?= $EducationResearch['program_pengurangan_emisi'] ? 'Ada' : 'Tidak Ada' ?></strong></li>
                        <li>Program Inovatif Energi: <strong><?= $EducationResearch['program_inovatif_energi'] ? 'Ada' : 'Tidak Ada' ?></strong></li>
                        <li>Program Dampak Iklim: <strong><?= $EducationResearch['program_dampak_iklim'] ? 'Ada' : 'Tidak Ada' ?></strong></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="alert alert-primary">
                        <strong>Capaian Persen:</strong> <?= number_format($EducationResearch['capaian_persen'], 2) ?>%
                    </div>
                </div>
            </div>

            <?php if ($EducationResearch['keterangan']): ?>
                <div class="mb-3">
                    <strong>Keterangan:</strong>
                    <p class="border p-2 bg-light"><?= nl2br(esc($EducationResearch['keterangan'])) ?></p>
                </div>
            <?php endif; ?>
            ...
            <?php if ($EducationResearch['bukti_pendukung']): ?>
                <div class="mb-3">
                    ...
                    <a href="<?= base_url('education-research/download/' . $EducationResearch['id']) ?>" class="btn btn-info mt-2">
            ...
            <form action="<?= base_url('education-research/process-verification/' . $EducationResearch['id']) ?>" method="post">
                <?= csrf_field() ?>
