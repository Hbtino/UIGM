        ...
        <div class="card-body">
            <form action="<?= base_url('education-research/update/' . $EducationResearch['id']) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="tahun" name="tahun" 
                                   value="<?= old('tahun', $EducationResearch['tahun']) ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="total_konsumsi_listrik" 
                                   name="total_konsumsi_listrik" value="<?= old('total_konsumsi_listrik', $EducationResearch['total_konsumsi_listrik']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="konsumsi_energi_terbarukan" 
                                   name="konsumsi_energi_terbarukan" value="<?= old('konsumsi_energi_terbarukan', $EducationResearch['konsumsi_energi_terbarukan']) ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="total_listrik_per_orang" 
                                   name="total_listrik_per_orang" value="<?= old('total_listrik_per_orang', $EducationResearch['total_listrik_per_orang']) ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="peralatan_hemat_energi" 
                                   name="peralatan_hemat_energi" value="<?= old('peralatan_hemat_energi', $EducationResearch['peralatan_hemat_energi']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="bangunan_cerdas" 
                                   name="bangunan_cerdas" value="<?= old('bangunan_cerdas', $EducationResearch['bangunan_cerdas']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="jumlah_energi_terbarukan" 
                                   name="jumlah_energi_terbarukan" value="<?= old('jumlah_energi_terbarukan', $EducationResearch['jumlah_energi_terbarukan']) ?>" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="bangunan_ramah_lingkungan" 
                                   name="bangunan_ramah_lingkungan" value="<?= old('bangunan_ramah_lingkungan', $EducationResearch['bangunan_ramah_lingkungan']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="jejak_karbon_per_orang" 
                                   name="jejak_karbon_per_orang" value="<?= old('jejak_karbon_per_orang', $EducationResearch['jejak_karbon_per_orang']) ?>" required>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="program_pengurangan_emisi" 
                                       ...
                                       <?= old('program_pengurangan_emisi', $EducationResearch['program_pengurangan_emisi']) ? 'checked' : '' ?>>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="program_inovatif_energi" 
                                       ...
                                       <?= old('program_inovatif_energi', $EducationResearch['program_inovatif_energi']) ? 'checked' : '' ?>>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="program_dampak_iklim" 
                                       ...
                                       <?= old('program_dampak_iklim', $EducationResearch['program_dampak_iklim']) ? 'checked' : '' ?>>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="keterangan" name="keterangan" rows="3"><?= old('keterangan', $EducationResearch['keterangan']) ?></textarea>
                </div>

                <div class="form-group">
                    <label for="bukti_pendukung">Bukti Pendukung</label>
                    <?php if ($EducationResearch['bukti_pendukung']): ?>
                        <p class="text-muted">File saat ini: <?= $EducationResearch['bukti_pendukung'] ?></p>
                    <?php endif; ?>
