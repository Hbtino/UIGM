    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                <h4 class="mb-0">Daftar Permintaan Revisi Setting & Infrastructure</h4>
                <a href="/setting-infrastructure" class="btn btn-light btn-sm">Kembali ke Data</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php $no = 1; foreach ($revisions as $rev): ?>
                                    ...
                                    $settingData = json_decode($rev['data_revisi'], true);
                                    $tahun = $settingData['tahun'] ?? '-';
                                    ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        ...
                                        <td>
                                            <?php if ($rev['status'] == 'pending'): ?>
                                                <a href="/setting-infrastructure/review-revision/<?= $rev['id'] ?>" class="btn btn-sm btn-primary">
                                                    Review
                                                </a>
                                            <?php else: ?>
                                                <a href="/setting-infrastructure/review-revision/<?= $rev['id'] ?>" class="btn btn-sm btn-info">
                                                    Lihat Detail
                                                </a>
                                            <?php endif ?>
                                        </td>
