    ...
    <div class="col-md-10 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-3">Data Setting & Infrastructure yang Akan Direvisi</h5>
                <div class="row mb-4">
                    <div class="col-md-6">
                        <table class="table table-sm table-bordered">
                            <tr>
                                <th width="50%">Tahun</th>
                                <td><?= $setting_infrastructure_data['tahun'] ?></td>
                            </tr>
                            <tr>
                                <th>Luas Total</th>
                                <td><?= number_format($setting_infrastructure_data['luas_total'], 2) ?> m²</td>
                            </tr>
                            <tr>
                                <th>Luas Ruang Terbuka</th>
                                <td><?= number_format($setting_infrastructure_data['luas_ruang_terbuka'], 2) ?> m²</td>
                            </tr>
                            <tr>
                                <th>Persentase Area Hijau</th>
                                <td><strong class="text-success"><?= $setting_infrastructure_data['persentase_area_hijau'] ?>%</strong></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table class="table table-sm table-bordered">
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <span class="badge <?= $statusBadge[$setting_infrastructure_data['status_verifikasi']] ?>">
                                        <?= ucfirst($setting_infrastructure_data['status_verifikasi']) ?>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <th>Persentase Anggaran</th>
                                <td><?= $setting_infrastructure_data['persentase_anggaran'] ?>%</td>
                            </tr>
                            <tr>
                                <th>Persentase Pemeliharaan</th>
                                <td><?= $setting_infrastructure_data['persentase_pemeliharaan'] ?>%</td>
                            </tr>
                            <tr>
                                <th>Capaian Persen</th>
                                <td><strong class="text-primary"><?= $setting_infrastructure_data['capaian_persen'] ?>%</strong></td>
                            </tr>
                        </table>
                    </div>
                </div>

                <?php if ($setting_infrastructure_data['bukti_pendukung']): ?>
                    <div class="mb-4">
                        <strong>Bukti Pendukung:</strong><br>
                        <a href="/setting-infrastructure/download/<?= $setting_infrastructure_data['id'] ?>" class="btn btn-info btn-sm mt-2">
                ...
                <?php if ($revision['status'] == 'pending'): ?>
                    ...
                    <form action="/setting-infrastructure/process-revision-review/<?= $revision['id'] ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="/setting-infrastructure/revisions" class="btn btn-secondary">Batal</a>
                        </div>
                    </form>
                <?php else: ?>
                    ...
                    <a href="/setting-infrastructure/revisions" class="btn btn-secondary">Kembali ke Daftar</a>
                <?php endif ?>
            </div>
        </div>
    </div>
