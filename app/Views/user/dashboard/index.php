            ...
            <div class="card">
                <div class="card-header" style="background: linear-gradient(135deg, #6f42c1 0%, #4c2a85 100%); color: white;">
                    <h3 class="card-title">
                        ...
                        Selamat Datang di Dashboard User UIGM
                    </h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p class="lead">Selamat datang di sistem dashboard UIGM (UI Green Metric) untuk User. Melalui dashboard ini, Anda dapat berkontribusi dalam program keberlanjutan kampus dengan menginput data lingkungan.</p>

                            <div class="alert alert-info">
                                <h5><i class="fas fa-info-circle"></i> Informasi Penting untuk User</h5>
                                <ul class="mb-0">
                                    <li>Saat ini hanya fitur <strong>Pengelolaan Limbah</strong> yang tersedia</li>
                                    <li>5 kategori lainnya akan segera hadir</li>
                                    <li>Data yang Anda input akan diverifikasi oleh admin</li>
                                    <li>Pastikan data yang diinput akurat dan sesuai dengan kondisi sebenarnya</li>
                                    <li>Anda berkontribusi langsung untuk kampus berkelanjutan</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-4">
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <p class="card-text">Bantu kampus dengan menginput data sampah anorganik, organik, limbah air, dan limbah berbahaya (B3)</p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <p class="card-text text-muted">Fitur akan segera tersedia untuk kontribusi Anda</p>
