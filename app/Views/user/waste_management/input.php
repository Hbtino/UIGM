            ...
            <div class="card">
                <div class="card-header" style="background: linear-gradient(135deg, #6f42c1 0%, #4c2a85 100%); color: white;">
                    <h3 class="card-title">
                        ...
                        Input Data Pengelolaan Limbah - User
                    </h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <!-- Form Input -->
                            <form action="<?= base_url('user-dashboard/store-waste-data') ?>" method="post" id="wasteForm">
                                <?= csrf_field() ?>
                                ...
                                <div class="row">
                                    ...
                                    <!-- Gedung -->
                                    <div class="col-md-6 mb-3">
                                        <label for="gedung" class="form-label">Gedung/Lokasi <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control <?= isset($validation) && $validation->hasError('gedung') ? 'is-invalid' : '' ?>"
                                            ...
                                            placeholder="Contoh: Gedung A, Lab Kimia, Kantin" required>
                            ...
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h5 class="mb-0">
                                        ...
                                        Tips Input Data untuk User
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <ul class="list-unstyled">
                                        <li><i class="fas fa-check text-success"></i> Pastikan data akurat dan jujur</li>
                                        ...
                                        <li><i class="fas fa-check text-success"></i> Data akan diverifikasi admin</li>
                                        <li><i class="fas fa-check text-success"></i> Kontribusi Anda sangat berarti</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
